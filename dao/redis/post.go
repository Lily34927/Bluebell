...
func getIDsFfromKey(key string, page, size int64) ([]string, error) {
	start := (page - 1) * size
	end := start + size - 1
...
func GetPostIDsInOrder(p *models.ParamPostList) ([]string, error) {
	...
	// 2.确定查询的索引起始点
	return getIDsFfromKey(key, p.Page, p.Size)
}

//keys bluebell*
//zrange bluebell:post:time 0 9 withscores
//zrevrange bluebell:post:time 0 9 withscores
